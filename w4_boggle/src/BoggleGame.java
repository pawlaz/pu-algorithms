...
public class BoggleGame extends JFrame {
    ...
    public BoggleGame(int rows, int cols) {
        ...
        foundWordsList.setCellRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList list, Object value, int index,
                ...
                Component comp = super.getListCellRendererComponent(list, value, index, false,
                                                                    false);
        ...
        opponentWordsScrollPane.setPreferredSize(
                new Dimension(WORD_PANEL_WIDTH, WORD_PANEL_HEIGHT));
        ...
        public void run() {
            if (elapsedTime < GAME_TIME - 1) {
                ...
                String seconds = String.format("%02d",
                                               (GAME_TIME - elapsedTime) % SECONDS_PER_MINUTE);
    ...
    private void makeMenuBar() {
        ...
        for (int i = 0; i < NUMBER_OF_LEVELS; i++) {
            ...
            difficultySelection[i].setActionCommand(
                    LEVEL_DESCRIPTION[i % LEVEL_DESCRIPTION.length]);
